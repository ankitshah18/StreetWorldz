      ...
      <div className="section-3">
        <div className="section_three_container">
          <h2 className="section_three_heading">
            <span style={{ color: "green" }}>Who we</span> are
          </h2>
          <div className="section_three_content">
            ...
            <p className="about_content">
              Our unwavering commitment to the well-being and recovery of these
              animals drives everything we do. We understand that accidents and
              illnesses can leave animals in desperate situations, and we are
              here to offer them a safe haven and the medical care they need.
            </p>
            <p className="about_content">
              ...
              to infections and diseases, we strive to rehabilitate each animal,
              working towards their full recovery.
            </p>
            <p className="about_content">
            ...
            <p className="about_content">
              ...
              educational materials to promote responsible pet ownership, as we
              believe that prevention is key to reducing the number of
              accidental and neglected animals.
            </p>
            <p className="about_content">
              Thank you for visiting Street Worldz. By supporting our cause, you
              are helping us save and improve the lives of ill, injured, and
              accidental animals, giving them the love and care they deserve.
              Together, we can make a profound difference in the lives of these
              precious beings.
            </p>
          </div>
        </div>
